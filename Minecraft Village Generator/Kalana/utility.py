...
if __name__ == "__main__":
    ...
    list_of_coordinates = [(0,0),(0,1),(1,0),(1,1)]
    
    print('...LOADING...')
    height = query_blocks(world.connection, list_of_coordinates, "world.getHeight(%d,%d)", int)
    bruh = []
    for coordinates in height:
        bruh.append([coordinates[0][0], coordinates[1], coordinates[0][1]])
    print(bruh)
